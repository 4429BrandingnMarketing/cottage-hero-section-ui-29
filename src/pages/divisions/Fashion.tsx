import { Shirt, Sparkles, ShoppingBag, ArrowRight, Star, Crown, Gem } from 'lucide-react';
    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(180deg, #0d0a07 0%, #1a1410 40%, #0d0a07 100%)' }}>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              ...
              <h1
                className="leading-none mb-4 text-[#c8962a]"
                style={{
              ...
              <p className="text-2xl italic text-[#b89a6a] mb-8" style={{ fontFamily: 'Garamond, "Times New Roman", serif', letterSpacing: '0.15em' }}>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href="https://redvisioncreativestudio.myshopify.com"
                  target="_blank"
                  ...
                  onMouseOver={e => { e.currentTarget.style.background = 'linear-gradient(135deg, #c8962a, #a07830)'; }}
                  onMouseOut={e => { e.currentTarget.style.background = 'linear-gradient(135deg, #8b7355, #6b5345)'; }}
                >
                  <ShoppingBag className="w-4 h-4" />
                  SHOP COLLECTION
                </a>
                <button
                  className="inline-flex items-center gap-2 px-8 py-4 text-[#c8962a] font-semibold transition-all duration-300"
                  style={{
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 80px rgba(200,150,42,0.15), inset 0 0 80px rgba(0,0,0,0.5)',
                }}
              >
                {/* Dark vintage base */}
                ...
                <div className="absolute top-8 left-0 right-0 text-center z-20">
                  <p className="text-[#a88c5a] tracking-[0.5em] uppercase" style={{ fontFamily: 'Garamond, serif', fontSize: '0.7rem' }}>
                    Welcome To
                  </p>
                </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center z-20 px-6">
                  <div
                    className="w-full py-10 px-8 text-center"
                    style={{
                  ...
                  >
                    ...
                    <h2
                      className="text-[#c8962a] leading-none mb-6"
                      style={{
                        fontFamily: '"Dancing Script", "Brush Script MT", cursive',
                    ...
                    <div
                      className="space-y-2 text-[#b89a6a]"
                      style={{ fontFamily: 'Garamond, serif', letterSpacing: '0.22em', fontSize: '0.65rem' }}
                    >
                    ...
                    <p
                      className="mt-5 text-[#c8962a] font-bold"
                      style={{ fontFamily: 'Garamond, serif', fontSize: '0.8rem', letterSpacing: '0.35em', textShadow: '0 0 10px rgba(200,150,42,0.3)' }}
                    >
                      #4429
                    </p>
                ...
                {/* Hover shimmer */}
                <div className="absolute inset-0 opacity-0 hover:opacity-100 transition-opacity duration-700 z-10" style={{ background: 'radial-gradient(ellipse at 50% 50%, rgba(200,150,42,0.06) 0%, transparent 65%)' }} />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 px-4" style={{ background: 'rgba(200,150,42,0.04)', borderTop: '1px solid rgba(139,115,85,0.3)' }}>
        <div className="max-w-7xl mx-auto">
          <motion.h2
            className="text-center text-[#c8962a] mb-16"
            style={{ fontFamily: 'Garamond, serif', fontSize: '2.5rem', fontWeight: 300, letterSpacing: '0.3em' }}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {collections.map((col, i) => (
              <motion.div
                ...
                style={{ background: 'rgba(26,20,16,0.8)', border: '1px solid rgba(139,115,85,0.4)' }}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: i * 0.15 }}
                whileHover={{ borderColor: 'rgba(200,150,42,0.6)' }}
              >
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <motion.h2
            className="text-center text-[#c8962a] mb-4"
            style={{ fontFamily: 'Garamond, serif', fontSize: '2.5rem', fontWeight: 300, letterSpacing: '0.3em' }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          >
            CRAFTED IN THE CULTURE
          </motion.h2>
          <p className="text-center text-[#8b7355] mb-16" style={{ fontFamily: 'Garamond, serif', letterSpacing: '0.15em' }}>
            Jason Salvador — relationships built across decades at the apex of fashion
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {influences.map((inf, i) => (
              <motion.div
                ...
                style={{ background: 'rgba(26,20,16,0.6)', border: '1px solid rgba(139,115,85,0.3)' }}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
      ...
      <section className="py-20 px-4 text-center" style={{ borderTop: '1px solid rgba(139,115,85,0.3)' }}>
        <div className="max-w-2xl mx-auto">
          ...
          <h2
            className="text-[#c8962a] mb-6"
            style={{
              fontFamily: '"Dancing Script", "Brush Script MT", cursive',
              fontSize: 'clamp(2.5rem, 6vw, 4rem)',
              fontWeight: 700,
              textShadow: '0 0 30px rgba(200,150,42,0.25)',
            }}
          >
            Giftd n' Privlgd
          </h2>
